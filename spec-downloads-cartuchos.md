...
## 3. Ubicación y descubribilidad

- La zona vive **apartada de la fila principal** de cabinets (Character Select, Training Mode, Meltdown, Binance) — no es una 5ta máquina en fila, es un rincón distinto de la sala.
- Como el riesgo de un easter egg es que nadie lo encuentre, agregar **una señal ambiental sutil** que guíe sin ser obvia:
  - Una luz de acento (glow sutil, ideal en violeta/púrpura para diferenciarla de los otros colores ya usados) visible desde la zona principal, que insinúa que hay algo más allá.
  - Opcional: un pequeño sonido ambiental de "máquina encendida" (zumbido bajo, loop) audible solo al acercarse, como pista sonora.
- Sin HUD de texto tipo "¡encontraste un secreto!" — la sala ya no usa ese lenguaje en ningún otro punto, mantener coherencia (nada de banners o etiquetas nuevas que no calcen con el resto).

## 4. La máquina expendedora (contenedor de los cartuchos)
...
## 6. Flujo de interacción (estados)
...
## 7. Audio (set completo de sonidos retro)
...
## 8. Manejo de archivos y descarga
...
## 9. Estructura de código sugerida (Three.js vanilla)
